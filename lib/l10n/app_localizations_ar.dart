...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get recommendFeature => 'اقترح ميزة';
  ...
  @override
  String get helpAddClient => 'أضف عميلاً من تبويب العملاء أو زر + في الرئيسية';

  @override
  String get helpAddOrder => 'أضف طلباً يدوياً أو بصوتك من تبويب الطلبات';

  @override
  String get helpAddPayment => 'افتح أي طلب لتسجيل دفعة كاملة أو جزئية';

  @override
  String get helpGeneratePdf =>
      'افتح عميلاً أو طلباً لإنشاء تقرير PDF ومشاركته';

  @override
  String get helpVoiceOrder =>
      'اضغط على أيقونة الميكروفون في إضافة طلب وتحدث بالعربي أو الإنجليزي';

  @override
  String get helpContactMessage => 'لديك سؤال أو وجدت خطأ؟ نحب أن نسمع منك.';

  @override
  String get helpSendFeedback => 'أرسل تعليقاً';
  ...
  @override
  String get feedbackSent => 'شكراً على اقتراحك!';

  @override
  String get feedbackFailed => 'فشل الإرسال. حاول مجدداً.';

  @override
  String get howToUseTheApp => 'كيف تستخدم التطبيق';
