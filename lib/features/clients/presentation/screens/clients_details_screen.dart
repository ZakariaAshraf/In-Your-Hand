            ...
            children: [
              Padding(
                ...
                child: CircleAvatar(
                  ...
                  radius: 60.r(context),
                  child: ClipOval(
                    child: Text(widget.client.name[0],style: theme.bodyLarge!.copyWith(fontSize: 50.sp(context)),)
                  ),
                ),
              ),
          ...
          BlocBuilder<OrdersCubit, OrdersState>(
            builder: (context, state) {
              if (state is OrdersSuccess) {
                ...
                final unpaidTotal = state.orders
                    .fold<double>(
                  0,
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return OrderItem(order: orders[index], client: widget.client, clientName: widget.client.name);
                          },
